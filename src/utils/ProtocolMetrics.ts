...
import { CirculatingSupply } from '../../generated/sOlympusERC20/CirculatingSupply';
import { ERC20 } from '../../generated/OlympusStaking/ERC20';
import { UniswapV2Pair } from '../../generated/OlympusStaking/UniswapV2Pair';
import { OlympusStaking } from '../../generated/OlympusStaking/OlympusStaking';

import { ProtocolMetric, Transaction } from '../../generated/schema'
import { CIRCULATING_SUPPLY_CONTRACT, CIRCULATING_SUPPLY_CONTRACT_BLOCK, ERC20DAI_CONTRACT, ERC20FRAX_CONTRACT,
OHM_ERC20_CONTRACT, SOHM_ERC20_CONTRACT, STAKING_CONTRACT, SUSHI_OHMDAI_PAIR, TREASURY_ADDRESS, 
UNI_OHMFRAX_PAIR, UNI_OHMFRAX_PAIR_BLOCK } from './Constants';
...
function getSohmSupply(transaction: Transaction): BigDecimal {
    ...
    sohm_supply = toDecimal(sohm_contract.circulatingSupply(), 9)
...
function getMV_RFV(transaction: Transaction): BigDecimal[] {
    ...
    // if (transaction.blockNumber.gt(BigInt.fromString(CONVEX_ALLOCATOR_BLOCK))) {
    //     let allocator = ConvexAllocator.bind(Address.fromString(CONVEX_ALLOCATOR))
    //     convexrfv = convexrfv.plus(toDecimal(allocator.totalValueDeployed(), 18))
    // }
    //OHMDAI
...
function getNextOHMRebase(transaction: Transaction): BigDecimal {
    ...
    let staking_contract = OlympusStaking.bind(Address.fromString(STAKING_CONTRACT))
...
export function updateProtocolMetrics(transaction: Transaction): void {
    ...
    pm.treasuryOhmFraxPOL = mv_rfv[7]
