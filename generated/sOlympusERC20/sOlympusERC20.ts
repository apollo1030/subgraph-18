...
export class sOlympusERC20__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sOlympusERC20 extends ethereum.SmartContract {
  ...
  rebases(param0: BigInt): sOlympusERC20__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sOlympusERC20__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(
    param0: BigInt
  ): ethereum.CallResult<sOlympusERC20__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new sOlympusERC20__rebasesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
